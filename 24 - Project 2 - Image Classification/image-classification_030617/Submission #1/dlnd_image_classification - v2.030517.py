...
def conv_net(x, keep_prob):
    ...
    conv_pool1 = conv2d_maxpool(x, 64, [2,2], [1,1], [2,2], [1,1])
    dropout1   = tf.nn.dropout(conv_pool1,keep_prob)
    conv_pool2 = conv2d_maxpool(dropout1, 64, [1,1], [1,1], [1,1], [1,1]) # 1x1 convolution!
    #dropout2   = tf.nn.dropout(conv_pool2,keep_prob)
    #conv_pool3 = conv2d_maxpool(dropout2, 64, [2,2], [1,1], [2,2], [1,1])
    #dropout3   = tf.nn.dropout(conv_pool3,keep_prob)
    ...
    dropout4  = tf.nn.dropout(fullyconn,keep_prob)
...
# Returning to a batch_size of 64.
