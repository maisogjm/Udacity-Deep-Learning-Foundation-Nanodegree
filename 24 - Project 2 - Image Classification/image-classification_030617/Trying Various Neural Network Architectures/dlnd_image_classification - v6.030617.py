...
def conv_net(x, keep_prob):
    ...
    conv_pool1 = conv2d_maxpool(x,        4, [2,2], [1,1], [4,4], [1,1])
    dropout1   = tf.nn.dropout(conv_pool1,keep_prob)
    conv_pool2 = conv2d_maxpool(dropout1, 4, [2,2], [2,2], [4,4], [2,2])
    ...
    fullyconn1 = fully_conn(flattened, 320)
    dropout2   = tf.nn.dropout(fullyconn1,keep_prob)
    fullyconn2 = fully_conn(dropout2, 80)
