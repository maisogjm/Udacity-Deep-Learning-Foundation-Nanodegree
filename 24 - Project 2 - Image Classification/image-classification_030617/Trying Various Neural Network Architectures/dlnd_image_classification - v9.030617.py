...
def conv_net(x, keep_prob):
    ...
    conv_pool2 = conv2d_maxpool(dropout1, 32, [3,3], [1,1], [2,2], [1,1])
    dropout2   = tf.nn.dropout(conv_pool2,keep_prob)
    conv_pool3 = conv2d_maxpool(dropout2, 32, [3,3], [1,1], [2,2], [1,1])
    
    # TODO: Apply a Flatten Layer
    # Function Definition from Above:
    #   flatten(x_tensor)
    flattened = flatten(conv_pool3)
    ...
    dropout3   = tf.nn.dropout(fullyconn1,keep_prob)
    fullyconn2 = fully_conn(dropout3, 256)
    dropout4   = tf.nn.dropout(fullyconn2,keep_prob)
