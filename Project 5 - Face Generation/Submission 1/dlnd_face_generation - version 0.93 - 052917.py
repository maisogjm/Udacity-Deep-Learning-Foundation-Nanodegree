...
#        x2 = tf.layers.conv2d(x2,filters=2,kernel_size=5, strides=1,padding='same')
#        x2 = tf.layers.batch_normalization(x2, training=is_train)
...
def model_loss(input_real, input_z, out_channel_dim):
    ...
    # Below is commented out code for label smoothing.
    # I am NOT using label smoothing at this time.
    # smooth = 0.1
#    d_loss_real = tf.reduce_mean(
